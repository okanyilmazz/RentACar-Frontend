...
export class CarService {
  ...
  getCarDetailByBody(bodyId: number): Observable<ListResponseModel<CarDetail>> {
  ...
  getCarDetailByBrandAndColor(
    brandId: number,
    colorId: number
  ): Observable<ListResponseModel<CarDetail>> {
    let newPath =
      this.apiUrl +
      'Cars/GetCarDetailByBrandAndColor?brandId=' +
      brandId +
      '&colorId=' +
      colorId;
    return this.httpClient.get<ListResponseModel<CarDetail>>(newPath);
  ...
  getCarDetailByBrandAndBody(
    brandId: number,
    bodyId: number
  ): Observable<ListResponseModel<CarDetail>> {
    let newPath =
      this.apiUrl +
      'Cars/GetCarDetailByBrandAndBody?brandId=' +
      brandId +
      '&bodyId=' +
      bodyId;
    return this.httpClient.get<ListResponseModel<CarDetail>>(newPath);
  ...
  getCarDetailByBodyAndColor(
    bodyId: number,
    colorId: number
  ): Observable<ListResponseModel<CarDetail>> {
    let newPath =
      this.apiUrl +
      'Cars/GetCarDetailByBodyAndColor?bodyId=' +
      bodyId +
      '&colorId=' +
      colorId;
    return this.httpClient.get<ListResponseModel<CarDetail>>(newPath);
  ...
  getCarDetailByBrandColorAndBody(
    brandId: number,
    colorId: number,
    bodyId: number
  ): Observable<ListResponseModel<CarDetail>> {
    let newPath =
      this.apiUrl +
      'Cars/GetCarDetailByBrandColorAndBody?brandId=' +
      brandId +
      '&colorId=' +
      colorId +
      '&bodyId=' +
